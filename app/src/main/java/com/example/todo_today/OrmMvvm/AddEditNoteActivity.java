...
public class AddEditNoteActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting datepicker
        Button datePickerButton = (Button) findViewById(R.id.button_openPicker);
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        EditText dateEditText2 = (EditText) findViewById(R.id.txtTodoDate);
        dateEditText2.setEnabled(false);
        dateEditText2.setText(currentDateString);
